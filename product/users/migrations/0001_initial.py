# Generated by Django 4.2.10 on 2024-08-21 06:36
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('group', models.ManyToManyField(to='courses.group')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('amount', models.DecimalField(decimal_places=2, default=Decimal('1000.00'), max_digits=10, verbose_name='Баланс')),
